...
// Service implements an amero netstats reporting daemon that pushes local
// chain statistics up to a monitoring server.
type Service struct {
	server *p2p.Server        // Peer-to-peer server to retrieve networking infos
	eth    *eth.amero      // Full amero service if monitoring a full node
	les    *les.Lightamero // Light amero service if monitoring a light node
...
func New(url string, ethServ *eth.amero, lesServ *les.Lightamero) (*Service, error) {
