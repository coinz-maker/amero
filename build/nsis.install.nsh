...
!define HELPURL "https://github.com/amero/go-amero/issues"
!define UPDATEURL "https://github.com/amero/go-amero/releases"
!define ABOUTURL "https://github.com/amero/go-amero#amero-go"
...
Section "Geth" GETH_IDX
  ...
  # Firewall - add rules
  SimpleFC::AdvAddRule "Geth incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "amero" 30303 "" "" ""
  SimpleFC::AdvAddRule "Geth outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "amero" "" 30303 "" ""
  SimpleFC::AdvAddRule "Geth UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "amero" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/amero/EIPs/issues/147)
  ${EnvVarUpdate} $0 "amero_SOCKET" "R" "HKLM" "\\.\pipe\geth.ipc"
  ${EnvVarUpdate} $0 "amero_SOCKET" "A" "HKLM" "\\.\pipe\geth.ipc"
