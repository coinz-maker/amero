...
import (
	...
	"github.com/amero/go-amero/crypto/sha3"
...
// ecrecover extracts the amero account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the amero address
...
// amero testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // amero address of the signing key
...
// Author implements consensus.Engine, returning the amero address recovered
