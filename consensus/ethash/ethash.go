...
// all blocks' seal as valid, though they still have to conform to the amero
// consensus rules.
...
// still have to conform to the amero consensus rules.
...
// they still have to conform to the amero consensus rules.
