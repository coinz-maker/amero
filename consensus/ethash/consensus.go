...
// rules of the stock amero ethash engine.
...
func calcDifficultyByzantium(time uint64, parent *types.Header) *big.Int {
	// https://github.com/amero/EIPs/issues/100.
	// algorithm:
	// diff = (parent_diff +
	...
	//   https://github.com/amero/EIPs/pull/669
...
func calcDifficultyHomestead(time uint64, parent *types.Header) *big.Int {
	// https://github.com/amero/EIPs/blob/master/EIPS/eip-2.md
	// algorithm:
	// diff = (parent_diff +
