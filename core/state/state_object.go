...
// stateObject represents an amero account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of amero address of the account
	data     Account
	db       *StateDB
...
// Account is the amero consensus representation of accounts.
