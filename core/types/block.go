...
// Package types contains data types related to amero consensus.
package types
...
// Header represents a block header in the amero blockchain.
type Header struct {
...
// Block represents an entire block in the amero blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// EncodeRLP serializes b into the amero RLP block format.
