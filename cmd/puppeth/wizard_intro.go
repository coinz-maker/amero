...
// setting up a new or managing an existing amero private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your amero private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new amero network down to  |")
	...
	log.Info("Administering amero network", "name", w.network)
