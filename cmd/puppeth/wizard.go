...
type wizard struct {
	...
	services map[string][]string   // amero services known to be running on servers
...
// converts it to an amero address. If an empty line is entered, the default
// value is returned.
