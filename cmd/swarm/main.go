...
import (
	...
	"github.com/amero/go-amero/cmd/utils"
	"github.com/amero/go-amero/common"
	"github.com/amero/go-amero/console"
	"github.com/amero/go-amero/crypto"
	"github.com/amero/go-amero/ethclient"
	"github.com/amero/go-amero/internal/debug"
	...
	"github.com/amero/go-amero/swarm"
	bzzapi "github.com/amero/go-amero/swarm/api"
	swarmmetrics "github.com/amero/go-amero/swarm/metrics"
...
var (
	...
	SwarmSwapAPIFlag = cli.StringFlag{
		Name:   "swap-api",
		Usage:  "URL of the amero API provider to use to settle SWAP payments",
...
var app = utils.NewApp(gitCommit, "amero Swarm")

// This init function creates the cli.App.
func init() {
	app.Action = bzzd
	app.HideVersion = true // we have a command to print the version
	app.Copyright = "Copyright 2013-2016 The go-amero Authors"
...
Export a local chunk database as a tar archive (use - to send to stdout).
    ...
    swarm db export ~/.amero/swarm/bzz-KEY/chunks chunks.tar

The export may be quite large, consider piping the output through the Unix
pv(1) tool to get a progress bar:

    swarm db export ~/.amero/swarm/bzz-KEY/chunks - | pv > chunks.tar
`,
				},
				{
					Action:    dbImport,
...
Import chunks from a tar archive into a local chunk database (use - to read from stdin).
    ...
    swarm db import ~/.amero/swarm/bzz-KEY/chunks chunks.tar

The import may be quite large, consider piping the input through the Unix
pv(1) tool to get a progress bar:

    pv chunks.tar | swarm db import ~/.amero/swarm/bzz-KEY/chunks -
`,
				},
				{
					Action:    dbClean,
...
func bzzd(ctx *cli.Context) error {
	...
	//register BZZ as node.Service in the amero node
...
func registerBzzService(bzzconfig *bzzapi.Config, ctx *cli.Context, stack *node.Node) {
	...
	//register within the amero node
