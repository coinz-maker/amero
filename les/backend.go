...
// Package les implements the Light amero Subprotocol.
package les
...
import (
	...
	"github.com/amero/go-amero/light"
	...
	rpc "github.com/amero/go-amero/rpc"
)

type Lightamero struct {
	config *eth.Config
...
func New(ctx *node.ServiceContext, config *eth.Config) (*Lightamero, error) {
...
func (s *Lightamero) APIs() []rpc.API {
...
func (s *Lightamero) ResetWithGenesisBlock(gb *types.Block) {
	s.blockchain.ResetWithGenesisBlock(gb)
}

func (s *Lightamero) BlockChain() *light.LightChain      { return s.blockchain }
func (s *Lightamero) TxPool() *light.TxPool              { return s.txPool }
func (s *Lightamero) Engine() consensus.Engine           { return s.engine }
func (s *Lightamero) LesVersion() int                    { return int(s.protocolManager.SubProtocols[0].Version) }
func (s *Lightamero) Downloader() *downloader.Downloader { return s.protocolManager.downloader }
func (s *Lightamero) EventMux() *event.TypeMux           { return s.eventMux }

// Protocols implements node.Service, returning all the currently configured
// network protocols to start.
func (s *Lightamero) Protocols() []p2p.Protocol {
	return s.protocolManager.SubProtocols
}

// Start implements node.Service, starting all internal goroutines needed by the
// amero protocol implementation.
func (s *Lightamero) Start(srvr *p2p.Server) error {
