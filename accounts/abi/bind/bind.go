...
// Package bind generates amero contract Go bindings.
//
// Detailed usage document and tutorial available on the go-amero Wiki page:
// https://github.com/amero/go-amero/wiki/Native-DApps:-Go-bindings-to-amero-contracts
package bind
