...
const (
	...
	MessageType_MessageType_ameroGetAddress       MessageType = 56
	MessageType_MessageType_ameroAddress          MessageType = 57
	MessageType_MessageType_ameroSignTx           MessageType = 58
	MessageType_MessageType_ameroTxRequest        MessageType = 59
	MessageType_MessageType_ameroTxAck            MessageType = 60
	...
	MessageType_MessageType_ameroSignMessage      MessageType = 64
	MessageType_MessageType_ameroVerifyMessage    MessageType = 65
	MessageType_MessageType_ameroMessageSignature MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	56:  "MessageType_ameroGetAddress",
	57:  "MessageType_ameroAddress",
	58:  "MessageType_ameroSignTx",
	59:  "MessageType_ameroTxRequest",
	60:  "MessageType_ameroTxAck",
	61:  "MessageType_GetECDHSessionKey",
	62:  "MessageType_ECDHSessionKey",
	63:  "MessageType_SetU2FCounter",
	64:  "MessageType_ameroSignMessage",
	65:  "MessageType_ameroVerifyMessage",
	66:  "MessageType_ameroMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_ameroGetAddress":       56,
	"MessageType_ameroAddress":          57,
	"MessageType_ameroSignTx":           58,
	"MessageType_ameroTxRequest":        59,
	"MessageType_ameroTxAck":            60,
	"MessageType_GetECDHSessionKey":        61,
	"MessageType_ECDHSessionKey":           62,
	"MessageType_SetU2FCounter":            63,
	"MessageType_ameroSignMessage":      64,
	"MessageType_ameroVerifyMessage":    65,
	"MessageType_ameroMessageSignature": 66,
...
// *
// Request: Ask device for amero address corresponding to address_n path
// @next PassphraseRequest
// @next ameroAddress
// @next Failure
type ameroGetAddress struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	ShowDisplay      *bool    `protobuf:"varint,2,opt,name=show_display,json=showDisplay" json:"show_display,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *ameroGetAddress) Reset()                    { *m = ameroGetAddress{} }
func (m *ameroGetAddress) String() string            { return proto.CompactTextString(m) }
func (*ameroGetAddress) ProtoMessage()               {}
func (*ameroGetAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{22} }

func (m *ameroGetAddress) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *ameroGetAddress) GetShowDisplay() bool {
	if m != nil && m.ShowDisplay != nil {
		return *m.ShowDisplay
	}
	return false
...
// *
// Response: Contains an amero address derived from device private seed
// @prev ameroGetAddress
type ameroAddress struct {
	Address          []byte `protobuf:"bytes,1,req,name=address" json:"address,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *ameroAddress) Reset()                    { *m = ameroAddress{} }
func (m *ameroAddress) String() string            { return proto.CompactTextString(m) }
func (*ameroAddress) ProtoMessage()               {}
func (*ameroAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{24} }

func (m *ameroAddress) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *ameroSignTx) Reset()                    { *m = ameroSignTx{} }
func (m *ameroSignTx) String() string            { return proto.CompactTextString(m) }
func (*ameroSignTx) ProtoMessage()               {}
func (*ameroSignTx) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{49} }

func (m *ameroSignTx) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *ameroSignTx) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *ameroSignTx) GetGasPrice() []byte {
	if m != nil {
		return m.GasPrice
	}
	return nil
...
func (m *ameroSignTx) GetGasLimit() []byte {
	if m != nil {
		return m.GasLimit
	}
	return nil
...
func (m *ameroSignTx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *ameroSignTx) GetDataInitialChunk() []byte {
	if m != nil {
...
func (m *ameroSignTx) GetDataLength() uint32 {
...
func (m *ameroSignTx) GetChainId() uint32 {
...
func (m *ameroTxRequest) Reset()                    { *m = ameroTxRequest{} }
func (m *ameroTxRequest) String() string            { return proto.CompactTextString(m) }
func (*ameroTxRequest) ProtoMessage()               {}
func (*ameroTxRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{50} }

func (m *ameroTxRequest) GetDataLength() uint32 {
	if m != nil && m.DataLength != nil {
		return *m.DataLength
	}
	return 0
...
func (m *ameroTxRequest) GetSignatureV() uint32 {
...
func (m *ameroTxRequest) GetSignatureR() []byte {
	if m != nil {
		return m.SignatureR
	}
	return nil
...
func (m *ameroTxRequest) GetSignatureS() []byte {
	if m != nil {
		return m.SignatureS
	}
	return nil
...
// @prev ameroTxRequest
// @next ameroTxRequest
type ameroTxAck struct {
	DataChunk        []byte `protobuf:"bytes,1,opt,name=data_chunk,json=dataChunk" json:"data_chunk,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *ameroTxAck) Reset()                    { *m = ameroTxAck{} }
func (m *ameroTxAck) String() string            { return proto.CompactTextString(m) }
func (*ameroTxAck) ProtoMessage()               {}
func (*ameroTxAck) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{51} }

func (m *ameroTxAck) GetDataChunk() []byte {
	if m != nil {
		return m.DataChunk
	}
	return nil
...
// *
// Request: Ask device to sign message
// @next ameroMessageSignature
// @next Failure
type ameroSignMessage struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Message          []byte   `protobuf:"bytes,2,req,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *ameroSignMessage) Reset()                    { *m = ameroSignMessage{} }
func (m *ameroSignMessage) String() string            { return proto.CompactTextString(m) }
func (*ameroSignMessage) ProtoMessage()               {}
func (*ameroSignMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{52} }

func (m *ameroSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *ameroSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// @next Success
// @next Failure
type ameroVerifyMessage struct {
...
func (m *ameroVerifyMessage) Reset()                    { *m = ameroVerifyMessage{} }
func (m *ameroVerifyMessage) String() string            { return proto.CompactTextString(m) }
func (*ameroVerifyMessage) ProtoMessage()               {}
func (*ameroVerifyMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{53} }

func (m *ameroVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *ameroVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *ameroVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// *
// Response: Signed message
// @prev ameroSignMessage
type ameroMessageSignature struct {
	Address          []byte `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Signature        []byte `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *ameroMessageSignature) Reset()                    { *m = ameroMessageSignature{} }
func (m *ameroMessageSignature) String() string            { return proto.CompactTextString(m) }
func (*ameroMessageSignature) ProtoMessage()               {}
func (*ameroMessageSignature) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{54} }

func (m *ameroMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *ameroMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*ameroGetAddress)(nil), "ameroGetAddress")
	proto.RegisterType((*Address)(nil), "Address")
	proto.RegisterType((*ameroAddress)(nil), "ameroAddress")
	...
	proto.RegisterType((*ameroSignTx)(nil), "ameroSignTx")
	proto.RegisterType((*ameroTxRequest)(nil), "ameroTxRequest")
	proto.RegisterType((*ameroTxAck)(nil), "ameroTxAck")
	proto.RegisterType((*ameroSignMessage)(nil), "ameroSignMessage")
	proto.RegisterType((*ameroVerifyMessage)(nil), "ameroVerifyMessage")
	proto.RegisterType((*ameroMessageSignature)(nil), "ameroMessageSignature")
