...
// Package accounts implements high level amero account management.
package accounts
...
// Account represents an amero account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // amero account address derived from the key
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain amero.ChainStateReader)
