...
// PeerInfo represents a short summary of the amero sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // amero protocol version negotiated
