...
import (
	...
	"github.com/amero/go-amero/common/bitutil"
...
const (
	// bloomServiceThreads is the number of goroutines used globally by an amero
...
func (eth *amero) startBloomHandlers() {
...
// for the amero header bloom filters, permitting blazing fast filtering.
